...
const CARDS = [
  ...
  { id: 'support_l',  name: 'Eternal Wish Crystal',   series: 'Support', rarity: 'L',  supportCard: true, supportEffect: 'any_wish',         desc: 'A crystal forged from pure desire — allows you to wish for Ultra Rare cards in addition to R/E/L/MY. Limited cards cannot be wished for. Passive effect while owned.' },
  ...
  { id: 'itachi_weapon',      name: "Itachi's Kunai",             series: 'Naruto',                            rarity: 'MY', weaponCard: true, weaponOf: 'itachi',      desc: "The legendary kunai wielded by Itachi Uchiha — a blade that ended and protected countless lives." },
  ...
  { id: 'zack_weapon',        name: "Zack's Taekwondo",            series: 'Lookism',                          rarity: 'MY', weaponCard: true, weaponOf: 'zack',        desc: "Zack Lee's legendary taekwondo axe kick — a technique refined to the point of near-invincibility." },
  ...
  { id: 'tom_lee_weapon',     name: "Tom Lee's Grappling Arts",    series: 'Lookism',                          rarity: 'UR', weaponCard: true, weaponOf: 'tom_lee',     desc: "Tom Lee's composed martial arts — a system of locks and throws that makes his opponents submit themselves." },
