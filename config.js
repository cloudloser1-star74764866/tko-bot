...
module.exports = {
  ...
  PULL_RATES: {
    R:  66.5,  // Rare        66.5%   (~2 in 3 pulls)
    E:  29,    // Epic        29%     (~1 in 3.5 pulls)
    L:   4,    // Legendary    4%     (~1 in 25 pulls)
    MY:  0.3,  // Mythical     0.3%   (~1 in 333 pulls)
    UR:  0.15, // Ultra-Rare   0.15%  (~1 in 667 pulls)
    LT:  0.05, // Limited      0.05%  (~1 in 2000 pulls)
  },
