...
const SEED = {
  ...
  // Weapon Cards — show character WITH weapon (action poses / character wielding)
  // Naruto weapons
  ...
  // Lookism weapons — show character in action/fight pose
  ...
  // Baki weapons — show character in fighting stance
  ...
  // Blue Lock weapons — show character in match/goal pose
...
const SEARCH_TERMS = {
  ...
  netero_weapon:    'Isaac Netero',    kira_weapon:      'Yoshikage Kira',
  kaido_weapon:     'Kaido',           muzan_weapon:     'Muzan Kibutsuji',
  sukuna_weapon:    'Ryomen Sukuna',   acnologia_weapon: 'Acnologia',
  escanor_weapon:   'Escanor',         daniel_weapon:    'Daniel Park',
  zack_weapon:      'Zack Lee',        jake_kim_weapon:  'Jake Kim',
  samuel_weapon:    'Samuel Seo',      pickle_weapon:    'Pickle',
  gun_weapon:       'Gun Park',        johan_weapon:     'Johan Seong',
  tom_lee_weapon:   'Tom Lee',         musashi_weapon:   'Miyamoto Musashi',
  yujiro_weapon:    'Yujiro Hanma',    giorno_weapon:    'Giorno Giovanna',
  simon_weapon:     'Simon',           saitama_weapon:   'Saitama',
  yhwach_weapon:    'Yhwach',          whitebeard_weapon:'Whitebeard',
  blackbeard_weapon:'Marshall D. Teach', beerus_weapon:  'Beerus',
};
